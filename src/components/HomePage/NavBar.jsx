    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          ...
          <li><Link to="portafolio" smooth={true} duration={500}>Portafolio</Link></li>
          <li><Link to="eventos" smooth={true} offset={-200} duration={500}>Eventos</Link></li>
          <li><Link to="support" smooth={true} offset={-50} duration={500}>Fotografos</Link></li>
          </ul>
        </div>
        <div className='hidden md:flex pr-4'>
          <button className='border-none bg-transparent text-black mr-4' onClick={onLogout}>   
          Cerrar Seccion
          </button>
        </div>
      ...
      <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
        ...
        <div className='flex flex-col my-4'>
          <button className='bg-transparent text-indigo-600 px-8 py-3 mb-4'>Cerrar Seccion</button>
        </div>
      </ul>
    </div>
  );
