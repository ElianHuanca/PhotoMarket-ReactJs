    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          ...
          <li><Link to="about" smooth={true} offset={-200} duration={500}>Acerca De Nosotros</Link></li>
        ...
        <div className='hidden md:flex pr-4'>
          ...
          <button className='px-8 py-3'><RouterLink  to="/auth/login" >
          Ingresar
          </RouterLink></button>
        </div>
      ...
      <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
        ...
        <div className='flex flex-col my-4'>
          <button className='bg-transparent text-indigo-600 px-8 py-3 mb-4'><RouterLink to="/auth/register">Registrase</RouterLink></button>
          <button className='px-8 py-3'><RouterLink  to="/auth/login" >Ingresar</RouterLink></button>
        </div>
      </ul>
    </div>
  );
